...
use Sistema\InscripcionBundle\Form\InscFichaPeritoType;
 ...
 *
 * @Route("/matriculado/inscripcion-peritos")
 */
class InscFichaPeritoController extends Controller {
     ...
     *
     * @Route("/", name="front_inscripcion_create_perito")
     * @Method("POST")
     * @Template("SistemaInscripcionBundle:InscFichaPerito:new.html.twig")
     */
    public function createAction() {
        ...
        if ($form->isValid()) {
            ...
            $nextAction = $this->generateUrl('front_inscripcion_peritos_show', array('id' => $entity->getId()));
     ...
     *
     * @Route("/{id}", name="front_inscripcion_peritos_show")
     * @Method("GET")
     * @Template()
     */
    ...
    protected function createCreateForm($entity) {
        ...
        $formType = new InscFichaPeritoType();
        
        $form = $this->createForm($formType, $entity, array(
            'action' => $this->generateUrl('front_inscripcion_create_perito'),
            'method' => 'POST',
        ));
     ...
     *
     * @Route("/get/pdf/{id}", name="front_inscripcion_perito_pdf")
     * @Method("GET")
     * @Template()
     */
    public function fichaPdfAction($id)
    {
        ...
        $renderView = 'SistemaInscripcionBundle:InscFichaPerito:fichaPdf.html.twig';
