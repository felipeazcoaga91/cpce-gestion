...
use Sistema\InscripcionBundle\Form\InscAdminFichaAsambleaType;

/**
 * InscFichaAsamblea controller admin.
 * @author Nombre Apellido <name@gmail.com>
 *
 * @Route("/admin/inscripciones/asamblea")
 */
class InscAdminFichaAsambleaController extends Controller
{

    /**
     * Section Admin Inscripciones Asamblea.
     *
     * @Route("/", name="admin_asamblea_index")
     * @Method("GET")
     * @Template()
     */
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SistemaInscripcionBundle:InscFichaAsamblea')->findAllFichasWithAfiliado();
