...
/**
 * InscMoldeFilterType filtro.
 * @author Nombre Apellido <name@gmail.com>
 */
class InscMoldeFilterType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('importeSubTotal', 'filter_number_range')
            ->add('hoteles', 'filter_choice')
            ->add('transportes', 'filter_choice')
            ->add('extras', 'filter_choice')
    ...
    {
        return 'sistema_inscripcionbundle_inschotelfiltertype';
    }
}
